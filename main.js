...
$(function(){
    ...
    $('#go').click(function(){
        ...
        shudu = new Sudoku(table);
    });
    //Test data set below,or you can remove it
    var nodes = [
        [0,0,0,6,9,0,0,8,1],
        [3,1,9,8,0,0,0,4,2],
        [0,5,0,0,1,0,0,9,3],
...
Sudoku.prototype.calcu = function(){
    var self = this;
...
//求X方向数集
Sudoku.prototype.xdirectionAll = function(x,y){
    var self = this;
    var arr = [];
    for(var j = 0; j < 9; j++){
...
//求Y方向数集
Sudoku.prototype.ydirectionAll = function(x,y){
    var self = this;
    var arr = [];
    for(var j = 0; j < 9; j++){
...
//求方格数集
Sudoku.prototype.RectAll = function(x,y){
    var self = this;
    var xModRet = x % 3;
    var yModRet = y % 3;
...
//设置某格值的显示
Sudoku.prototype.ShowNum = function(x,y,num){
    var self = this;
